...
export const getAppSidebarHeight = (width, visibleAppFooter) => {
  switch (width) {
    ...
    default:
      return (
        AppHeaderHeight + AppMainContentPadding + InBuildAppHeaderHeight + InBuildAppSidebarHeaderHeight + (visibleAppFooter ? AppHeaderHeight : 0)
      );
  }
};
...
export const getMailContainerHeight = (width, visibleAppFooter) => {
  switch (width) {
    case 'xs':
      return (
        AppHeaderHeightSm + AppMainContentPadding + InBuildAppHeaderHeight + MailAppContentHeaderHeight + (visibleAppFooter ? AppFooterHeightSm : 0)
      );
    case 'sm':
      return (
        AppHeaderHeightSm + AppMainContentPadding + InBuildAppHeaderHeight + MailAppContentHeaderHeight + (visibleAppFooter ? AppFooterHeightSm : 0)
...
export const getTaskDetailContainerHeight = (width, visibleAppFooter) => {
  switch (width) {
    case 'xs':
      return (
        AppHeaderHeightSm + AppMainContentPadding + TaskDetailHeaderHeight + TaskDetailAddCommentHeight + (visibleAppFooter ? AppFooterHeightSm : 0)
      );
    case 'sm':
      return (
        AppHeaderHeightSm + AppMainContentPadding + TaskDetailHeaderHeight + TaskDetailAddCommentHeight + (visibleAppFooter ? AppFooterHeightSm : 0)
...
export const getChatSidebarHeight = (width, visibleAppFooter) => {
  switch (width) {
    ...
    default:
      return (
        AppHeaderHeight + AppMainContentPadding + ChatSidebarHeaderHeight + ChatSidebarTabContainerHeight + (visibleAppFooter ? AppFooterHeight : 0)
      );
  }
};
